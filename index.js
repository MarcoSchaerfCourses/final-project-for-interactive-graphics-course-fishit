...
function init() {
    ...
    // CONTROL MENU
    controls = document.getElementById('control-menu');
    controls.style.position = 'absolute';
    controls.style.top = '5%';
...
function initModels() {
    ...
    loader.load(
        ...
        function (gltf) {
            ...
            greenM.castShadow = true;
            instance1 = greenM.clone();
            instance2 = greenM.clone();
            instance3 = greenM.clone();
            greenM.position.set(0, 900, -2300);
            ...
            fixedObjects[0] = new THREE.Mesh(objectGeometry, objectMaterial);
            fixedObjects[0].position.x = greenM.position.x;
            fixedObjects[0].position.y = greenM.position.y;
            ...
            fixedObjects[1] = new THREE.Mesh(objectGeometry, objectMaterial);
            fixedObjects[1].position.x = instance1.position.x;
            fixedObjects[1].position.y = instance1.position.y;
            ...
            fixedObjects[2] = new THREE.Mesh(objectGeometry, objectMaterial);
            fixedObjects[2].position.x = instance2.position.x;
            fixedObjects[2].position.y = instance2.position.y;
            ...
            fixedObjects[3] = new THREE.Mesh(objectGeometry, objectMaterial);
            fixedObjects[3].position.x = instance3.position.x;
            fixedObjects[3].position.y = instance3.position.y;
            fixedObjects[3].position.z = instance3.position.z;

            //collidableMeshList.push(movingCubes[i]);
            scene.add(fixedObjects[0]);
